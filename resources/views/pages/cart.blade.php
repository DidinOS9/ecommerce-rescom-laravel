...
@section('content')
    <!-- Page Content -->
    <body class="page-content page-cart">
      <section
          ...
          <form action="{{ route('checkout') }}" id="locations" method="POST" enctype="multipart/form-data">
            ...
            <div class="row" data-aos="fade-up" data-aos-delay="300">
              <div class="col-4 col-md-2">
                ...
                <div class="peoduct-subtitle">Country Tax</div>
              </div>
              <div class="col-4 col-md-3">
                <div class="product-title">$0</div>
                <div class="peoduct-subtitle">Product Insurance</div>
              </div>
              <div class="col-4 col-md-2">
                <div class="product-title">$0</div>
                <div class="peoduct-subtitle">Ship to Jakarta</div>
              </div>
              <div class="col-4 col-md-2">
